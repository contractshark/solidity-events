...
describe("generator", () => {
  ...
  it("creates importedClass.ts", () => {
    expect(
      generateTemplateClassesFromXSD("./test/xsd/importedClass.xsd", {
        dep: "./ns",
  ...
  it("creates simpleInheritedClass.ts", () => {
    expect(
      generateTemplateClassesFromXSD("./test/xsd/simpleInheritedClass.xsd", {
        Xs: "./ns",
      } as Map<string, string>)
    );
  ...
  it("creates capabilities_1_3_0.ts", () => {
    expect(
      generateTemplateClassesFromXSD("./test/xsd/capabilities_1_3_0.xsd", {
        wms: "./wms",
      })
    );
  ...
  it("creates defNamespace.ts", () => {
    expect(
      generateTemplateClassesFromXSD("./test/xsd/defNamespace.xsd", {
        dep: "./ns",
      })
    );
